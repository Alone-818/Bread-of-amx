package Alone818.com.bread_of_amx.BlockEntities;
...
public class toast_feeding_range_BlockEntity extends BlockEntity {
     ...
     */
    public toast_feeding_range_BlockEntity(BlockPos pPos, BlockState pBlockState) {
        ...
        //   2. 它附着在哪个位置
        //   3. 它对应的方块状态是什么
        super(ModBlockEntities.TOAST_FEEDING_RANGE_BLOCKENTITY.get(), pPos, pBlockState);
    }
